...
const CategoryGrid = () => {
  ...
  const categories = [
    { title: t("cat.haircare"), cta: t("cat.haircare.cta"), image: haircareImg, link: "/store" },
    { title: t("cat.academy"), cta: t("cat.academy.cta"), image: academyImg, link: "/academy" },
    { title: t("cat.tools"), cta: t("cat.tools.cta"), image: toolsImg, link: "/store" },
  ];
      ...
      {categories.map((cat) => (
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-foreground">
            <p className="text-xs tracking-[0.15em] font-body text-foreground/70 mb-2">{cat.title}</p>
